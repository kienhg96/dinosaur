...
"use strict";
/* WEBPACK VAR INJECTION */(function(global) {Object.defineProperty(exports, "__esModule", { value: true });var _global = global,cc = _global.cc;exports.default =
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var res = exports.res = {
    // Start Button
    StartButtonN: "res/StartButton/start_n.png",
    StartButtonS: "res/StartButton/start_s.png",
    // Menu Background
    MenuBackground: "res/MenuBackground.png",
    PlayBackground: "res/PlayBackground.png",
    Dinosaur: "res/Dinosaur.png" };


var g_resources = Object.values(res);exports.default =
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.DinosaurLayer = exports.PlayBackgroundLayer = exports.MenuBackgroundLayer = exports.MenuLayer = undefined;var _MenuLayer = __webpack_require__(332);var _MenuLayer2 = _interopRequireDefault(_MenuLayer);
var _MenuBackgroundLayer = __webpack_require__(333);var _MenuBackgroundLayer2 = _interopRequireDefault(_MenuBackgroundLayer);
var _PlayBackgroundLayer = __webpack_require__(334);var _PlayBackgroundLayer2 = _interopRequireDefault(_PlayBackgroundLayer);
var _DinosaurLayer = __webpack_require__(336);var _DinosaurLayer2 = _interopRequireDefault(_DinosaurLayer);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}exports.


MenuLayer = _MenuLayer2.default;exports.MenuBackgroundLayer = _MenuBackgroundLayer2.default;exports.
PlayBackgroundLayer = _PlayBackgroundLayer2.default;exports.DinosaurLayer = _DinosaurLayer2.default;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global) {var _resource = __webpack_require__(50);var _resource2 = _interopRequireDefault(_resource);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _global =
global,cc = _global.cc;

cc.game.onStart = function () {
    var MenuScene = __webpack_require__(331).default;
    var sys = cc.sys;
    ...
    //load resources
    cc.LoaderScene.preload(_resource2.default, function () {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _cc = __webpack_require__(42);var _cc2 = _interopRequireDefault(_cc);
var _Layers = __webpack_require__(126);
var _PlayScene = __webpack_require__(339);var _PlayScene2 = _interopRequireDefault(_PlayScene);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}exports.default =

_cc2.default.Scene.extend({
    ...
    render: function render() {
        var backgroundLayer = new _Layers.MenuBackgroundLayer();
        this.addChild(backgroundLayer);
        var menuLayer = new _Layers.MenuLayer(function () {
            _cc2.default.director.runScene(new _PlayScene2.default());
        });
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _cc = __webpack_require__(42);var _cc2 = _interopRequireDefault(_cc);
var _resource = __webpack_require__(50);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}exports.default =

_cc2.default.Menu.extend({
    ctor: function ctor(onPlayClick) {
        this._super();
    ...
    render: function render() {
        var menuItemSprites = new _cc2.default.MenuItemSprite(
        new _cc2.default.Sprite(_resource.res.StartButtonN),
        new _cc2.default.Sprite(_resource.res.StartButtonS),
        this.onPlay,
        this);
...
_cc2.default.Layer.extend({
	...
	render: function render() {var
		winSize = _cc2.default.winSize;
		var center = _cc2.default.p(winSize.width / 2, winSize.height / 2);
		// Add Background
		var background = new _cc2.default.Sprite(_resource.res.MenuBackground);
...
var _speed = __webpack_require__(335);var _speed2 = _interopRequireDefault(_speed);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}exports.default =
...
_cc2.default.Layer.extend({
	...
	render: function render() {var
		winSize = _cc2.default.winSize;
		// Add Background
		this.bg1 = new _cc2.default.Sprite(_resource.res.PlayBackground);
		this.bg1.setPosition(_cc2.default.p(
		winSize.width / 2,
		winSize.height / 2));

		this.bgWidth = this.bg1.getContentSize().width;
		this.addChild(this.bg1);
		this.bg2 = new _cc2.default.Sprite(_resource.res.PlayBackground);
		this.bg2.setPosition(_cc2.default.p(
	...
	update: function update(dt) {
		var distance = dt * _speed2.default;
		var newPosBg1 = this.bg1.getPositionX() - distance;
		var newPosBg2 = this.bg2.getPositionX() - distance;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = 250;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _cc = __webpack_require__(42);var _cc2 = _interopRequireDefault(_cc);
var _Sprites = __webpack_require__(337);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}exports.default =
...
_cc2.default.Layer.extend({
	...
	render: function render() {
		this.dinosaur = new _Sprites.DinosaurSprite();
		var dinoSize = this.dinosaur.getContentSize();
		this.dinosaur.setPosition(_cc2.default.p(
		120 + dinoSize.height / 2,
		70 + dinoSize.width / 2));
	...
	jump: function jump() {var _this = this;
		if (!this.jumpLock) {
			this.jumpLock = true;
			var jumpAction = new _cc2.default.jumpBy(0.5, _cc2.default.p(0, 0), 150, 1);
			this.dinosaur.runAction(_cc2.default.sequence(jumpAction,
			_cc2.default.callFunc(function () {return _this.jumpLock = false;}, this)));
		}
	},

	initEvent: function initEvent() {
		_cc2.default.eventManager.addListener({
			event: _cc2.default.EventListener.TOUCH_ONE_BY_ONE,
			swallowTouches: true,
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.DinosaurSprite = undefined;var _DinosaurSprite = __webpack_require__(338);var _DinosaurSprite2 = _interopRequireDefault(_DinosaurSprite);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}exports.

DinosaurSprite = _DinosaurSprite2.default;
...
_cc2.default.Sprite.extend({
    ctor: function ctor() {
        this._super(_resource.res.Dinosaur);
    } });
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });var _cc = __webpack_require__(42);var _cc2 = _interopRequireDefault(_cc);
var _Layers = __webpack_require__(126);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}exports.default =
...
_cc2.default.Scene.extend({
    ...
    render: function render() {
        var background = new _Layers.PlayBackgroundLayer();
        var dinosaurLayer = new _Layers.DinosaurLayer();
        this.addChild(background);
        this.addChild(dinosaurLayer);
    } });

/***/ })
/******/ ]);
//# sourceMappingURL=main.d272b6f2e35b6ab6f71b.js.map